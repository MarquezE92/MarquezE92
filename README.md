...
<img width ='32px' src ='https://railway.app/brand/logo-dark.svg'>
...
<div> HTML | CSS | JavaScript | React | Redux | MUI | Node.js | Express.js | MongoDB-Atlas/Mongoose | AWS | Hostinger | Bcrypt | JSONWebToken | Nodemailer | OAuth 2.0 | CheckoutAPI Mercadopago | Mobbex API | Ultramsg API | Cloudinary | Notion</div>
<br>
<div>The website allows you to: </div>
<div>✅ Upload all the relevant data of the services you offer to a personalized store that you can share with your clients.</div>
...
<div align="row" >
      ...
      <img src="./PacienteMob.PNG" width="250" height="auto"  />
